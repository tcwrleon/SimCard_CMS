...
public class PhoneUtil {
     ...
     * @author LinBilin
     */
    public static boolean isChinaCTCCPhoneNum(String str) {
     ...
     * @author LinBilin
     */
    public static boolean isChinaCUCCPhoneNum(String str) {
     ...
     * @author LinBilin
     */
    public static boolean isChinaCMCCPhoneNum(String str) {
        ...
        if(!StringUtil.isEmpty(content)) {
            for (int i = 0; i < content.length(); i++) {
                if (Character.isDigit(content.charAt(i))) {
                    code = "";
                    for (int j = i; j < content.length(); j++, i++) {
                        if (Character.isDigit(content.charAt(j))) {
                            code += content.charAt(j);
                        } else {
                            break;
                        }
                    }
