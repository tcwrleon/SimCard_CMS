...
<body>
	...
	<form action="smsRecAction_toQueryCUCC" method="post" name="qryForm">
	...
	<input type="hidden" name="_backUrl" value="smsRecAction_toQueryCUCC"/>
	</form>
    <div class="toolBar">
...
<!--     	<a class="button" onclick="smsRecAction_toAdd()">新增</a>
	...
	<div class="page-tag clearfix">
		<div style="float:left">
			<form action="smsRecAction_toQueryCUCC" method="post" name="listForm">
	...
	<script type="text/javascript">
		...
		var queryUrl = "smsRecAction_toQueryCUCC";
		...
		function smsRecAction_toDel() {
			...
			if(id == ""){
				...
				if(confirm("确定要删除所选短信信息吗？")) {
					detailForm.action = "smsRecAction_deleteCUCC";
